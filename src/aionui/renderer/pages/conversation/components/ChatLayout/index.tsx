...
const ChatLayout: React.FC<{
  ...
  return (
    <ArcoLayout
      className='size-full min-h-0 color-black'
      style={{
        // fontFamily: `cursive,"anthropicSans","anthropicSans Fallback",system-ui,Segoe UI,Roboto,Helvetica,Arial,sans-serif`,
      }}
    >
      <div ref={containerRef} className='flex flex-1 relative w-full h-full min-h-0 overflow-hidden'>
        ...
        >
          ...
          <div className='flex flex-1 min-h-0 relative'>
            ...
            >
              <ArcoLayout.Content className='flex flex-col flex-1 bg-1 min-h-0 overflow-hidden'>
                {props.children}
              </ArcoLayout.Content>
            </div>
