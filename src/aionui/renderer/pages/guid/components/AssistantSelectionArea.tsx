...
const AssistantSelectionArea: React.FC<AssistantSelectionAreaProps> = ({
  ...
  if (is_presetAgent && selectedAgentInfo) {
    ...
    return (
      <div className={`${styles.assistantSelectionArea} ${styles.assistantSelectionAreaCompact}`}>
        <div className='flex flex-col w-full animate-fade-in'>
          ...
          {(() => {
            ...
            const prompts = agent?.prompts_i18n?.[localeKey] || agent?.prompts;
  ...
  // Assistant List View
  return (
    <div className={styles.assistantSelectionArea}>
      <div className={`${styles.assistantPromptHint} ${styles.assistantSelectionHint} text-center mb-12px`}>
